# Generated by Django 3.0.6 on 2020-05-30 15:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('set_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='set_by_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
